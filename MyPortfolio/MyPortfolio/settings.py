...
# MESSAGE_TAGS = {
#     messages.ERROR: 'danger',  # Use 'danger' for Bootstrap styling
...
DATABASES = {
    'default': {
        ...
        'NAME': 'flask_users',           # The name of your MySQL database
        'USER': 'root',                    # The MySQL username
        'PASSWORD': 'root',            # The MySQL password
        'HOST': 'localhost',                  # The host (use '127.0.0.1' or 'localhost')
